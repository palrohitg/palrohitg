...
|---|---|---|---|
| [OpenHands](https://github.com/OpenHands) | [OpenHands/automation#460 — fix(presets): install SDK into the run virtualenv](https://github.com/OpenHands/automation/pull/460) | 🟡 In review | 2026-09-14 |
...
_Last refreshed 2026-09-14 · Tracking OpenHands, SynthLuvr automatically._
<!-- PR-TRACKER:END -->
